...
tipoerr:
    ...
    Private Sub GuardarMarca()
        ...
        With Comando.Parameters
            .AddWithValue("IdMarca", txtRuta.Text)
            .AddWithValue("Marca", txthoja.Text.Trim)
        End With
...
tipoerr:
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Ruta = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Me.txtRuta.Text.Trim & "; Extended Properties=Excel 8.0"

        'Ruta = "Provider=Microsoft.JET.OLEDB.4.0;DataSource=" & Me.txtRuta.Text & ";Extended Properties= Excel 4.0"
...
tipoerr:
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        OFD.InitialDirectory = System.Environment.SpecialFolder.MyComputer.ToString
